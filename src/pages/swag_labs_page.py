...
class SwagLabsPage:
    ...
    def add_product_to_cart(self):
        """固定添加 Sauce Labs Backpack（原有方法保留，兼容旧用例）"""
        self.add_cart_btn.wait_for(state="visible", timeout=8000)
    ...
    def go_to_cart(self):
        """跳转到购物车页面"""
        self.shopping_cart_icon.wait_for(state="visible", timeout=8000)
    ...
    def remove_item_from_cart(self, item_name: str):
        ...
        remove_btn.wait_for(state="visible", timeout=8000)
        remove_btn.click()
